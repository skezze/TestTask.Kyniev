...
namespace Chat.Application.Repositories.Interfaces
{
    public interface IChatRoomRepository
    {
        ...
        Task<IEnumerable<ChatRoom>> SearchChatRoomsAsync(string searchTerm);
        ...
        Task JoinChatRoomAsync(int chatRoomId, IGroupManager groups, HubCallerContext context, IHubCallerClients clients);
        Task LeaveChatRoomAsync(int chatRoomId, IGroupManager groups, HubCallerContext context, IHubCallerClients clients);
    }
}
